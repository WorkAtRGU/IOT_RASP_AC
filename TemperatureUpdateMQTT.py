...
client = mqttClient.Client("Lfee1")
...
try:
    while True:
        ...
        Sensor1 = {"id":1, "setTemperature":25, "Temperature":temperatureC}

        print("Test ",json.dumps(Sensor1))
                
        client.publish("llindsay971/feeds/coursework.testingData", json.dumps(Sensor1), qos=0, retain=False)
